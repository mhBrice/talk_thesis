...
# 
quartz(width = 4.7, height = 5.4)
png("images/chap1_reg_tbi.png", width = 4.7, height = 5.4, res = 300, units = "in")
layout(matrix(c(1, 2), 1), widths = c(.45, 1))
...
# Coefs labels
text(1, x_lab, labs_expressions, xpd = NA, adj = 1, cex = .96)
...
png("images/chap1_thermo_aov.png", width = 5, height = 4, res = 300, units = "in")
...
axis(1, at = 1:3, labels = c("Peu ou pas", "Modérée", "Majeure"), cex = 1.1)
arrows(x0 = 1:3,  
       y0 = eff_aov$disturb$lower,
       y1 = eff_aov$disturb$upper,
       code = 0, lwd = 1.5, col = c("grey15", "red3", "grey15"))
mtext("Intensité de perturbations", 1, line = 2.4, font = 2, cex = 1.1)
mtext("Thermophilisation", 2, line = 2.8, font = 2, cex = 1.1)
